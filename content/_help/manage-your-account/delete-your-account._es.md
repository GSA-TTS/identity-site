...
<div class="usa-accordion usa-accordion--bordered margin-y-4">
  ...
  <div id="b-a1" class="usa-accordion__content usa-prose">
    <ol class="number-list">
      <li>Ingrese su dirección de correo electrónico en <a href="https://secure.login.gov/es" class="usa-link">https://secure.login.gov</a>.</li>
...
<div class="usa-accordion usa-accordion--bordered margin-y-4">
  <h2 class="usa-accordion__heading">
    <button
      ...
      aria-controls="b-a2"
    >
      Si NO tiene acceso a sus métodos de autenticación, siga estos pasos para eliminar su cuenta:
    </button>
  </h2>
  <div id="b-a2" class="usa-accordion__content usa-prose">
    ...
    <ol class="number-list">
      <li>Vaya a la página de inicio de sesión de su aplicación del gobierno o a <a href="https://secure.login.gov/es" class="usa-link">https://secure.login.gov</a>.</li>
