...
1. Primero, ingrese su dirección de correo electrónico en <https://secure.login.gov/es/sign_up/enter_email>.
...
6. Configure un segundo nivel de seguridad.
   ...
   * Códigos de recuperación
   ...
   [Obtenga más información sobre cada opción de autenticación](/es/help/get-started/authentication-methods/) para elegir la más apropiada para usted.
