...
身份证实应用程序会下载到你设备上，并生成用于登录帐户的安全的、六位数的一次性代码。虽然如果你设备丢失或被盗，身份证实应用程序不受保护，但对于防止网络钓鱼、黑客攻击或拦截来说，这种方法比接听电话或短信更安全。
...
以后每次登录Login.gov，你就能使用这个应用程序生成的一次性代码了。
...
SMS/短信或接听电话很方便，但极易遭到盗窃、黑客和其他攻击。
...
收到代码后，请将其打入“一次性代码”域。每次登录 Login.gov 时，你都可以选择通过接听电话或SMS/短信获取新的一次性代码。每次你登录 Login.gov，都会收到一个新的一次性代码。
