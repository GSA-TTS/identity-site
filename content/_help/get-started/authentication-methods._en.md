...
You will now be able to use the one-time code generated by the application each time you sign in to Login.gov.
...
After you receive the code, type it into the “One-time code” field. Each time you sign in to Login.gov you’ll have the option of getting a new one-time code by phone call or SMS/text. You will receive a new one-time code each time you sign in to your Login.gov account.
