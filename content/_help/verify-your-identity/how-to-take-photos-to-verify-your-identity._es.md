---
layout: help
title: Tomar fotos de mi identificación
...
Necesita un teléfono o una tableta con cámara para tomar las fotografías de su identificación con la herramienta de la cámara de Login.gov. No puedes usar una cámara web. Si usa una computadora, le enviaremos un mensaje de texto con un vínculo para abrir Login.gov en su teléfono o tableta. Después de tomar las fotografías, volverá a su computadora.
...
### Login.gov no pudo verificar mi identificación

Si envía sus fotos y recibe un mensaje de error que indica que su identificación no se pudo verificar, asegúrese de que está usando [un tipo identificación aceptable](/es/help/verify-your-identity/accepted-id-type/).
...
* [Verificar mi identidad](/es/help/verify-your-identity/overview/)
* [Tómese una selfi](/es/help/verify-your-identity/issues-taking-a-photo-of-myself/)
