...
permalink: /help/verify-your-identity/accepted-id-type/
order: 2
do_list:
  ...
  - "**Mobile driver’s license (mDL) or state ID in a digital wallet.** Accepted in select digital wallets, including Google Wallet and Samsung Wallet. Availability depends on your state, device, and wallet. We’re working to support additional digital wallets. If your state or wallet is not supported, you can use another accepted ID type."
dont_list:
  - Non-U.S. passports
  - Military IDs
...
* [Verify my information](/help/verify-your-identity/overview/)
* [Verify my phone number](/help/verify-your-identity/phone-number/)
* [Verify in person](/help/verify-your-identity/verify-your-identity-in-person/)
