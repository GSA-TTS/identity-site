---
layout: help
title: ¿Cómo puedo asegurarme de que los mensajes que he recibido son reales?
category: fraud-concerns
permalink: /es/help/fraud-concerns/verify-messages/
order: 2
---
...
1. Verifique los datos del remitente
...
2. Busque señales de mensajes fraudulentos
...
3. No haga clic en enlaces ni descargue archivos adjuntos
...
4. Verificar utilizando fuentes oficiales
   - Llámenos directamente: Utilice el número oficial que aparece en nuestra página de [contacto](/es/contact/).
   - Verifique su cuenta: inicie sesión a través del sitio web oficial [Login.gov](https://login.gov/es/), en lugar de hacer clic en los enlaces del mensaje sospechoso.
