...
2. Descargue e instale una aplicación de autenticación en su dispositivo. Algunas de las opciones preferidas son:
   ...
   * Aplicaciones para Mac: [1Password](https://1password.com/), [Dashlane](https://apps.apple.com/us/app/dashlane-password-manager/id517914548?l=es-MX&platform=mac).
   * Extensiones para Chrome: [Authenticator](https://chrome.google.com/webstore/detail/authenticator/bhghoamapcdpbohphigoooaddinpkbai?hl=es).
...
* [Problemas con las aplicacións de autenticación](/es/help/trouble-signing-in/authentication/issues-with-authentication-application/)
