...
2. Téléchargez et installez une application d'authentification sur votre appareil. Voici quelques options courantes :
   ...
   * Applications Windows : [1Password](https://1password.com/), [OTP Manager](https://apps.microsoft.com/detail/9nblggh6hngn?hl=fr-fr&gl=US).
   * Applications Mac : [1Password](https://1password.com/), [Dashlane](https://apps.apple.com/us/app/dashlane-password-manager/id517914548?l=fr-FR&platform=mac).
...
* [Problèmes avec les applications d'authentification](/fr/help/trouble-signing-in/authentication/issues-with-authentication-application/)
