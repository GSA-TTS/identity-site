...
Après avoir validé les preuves d'identité que vous nous avez fournies, nous vérifions que vous êtes bien cette personne. Pour ce faire, nous pouvons vous demander de prendre une photo de vous-même (un selfie) afin de la comparer à la photo d'identité que vous avez fournie, comme celle de votre permis de conduire ou passeport.
