...
Login.gov 服务由联邦总务管理局（GSA）提供，让公众可以安全和私密地在网上访问参与 Login.gov 的政府计划。用户只要一个 Login.gov 账户，就能登录多个政府机构。我们的目标是让管理联邦福利、服务以及申请更容易和安全。
...
* 提供给远程或亲身身份证实和身份核证服务的第三方，包括必要时提供这种服务的其他联邦机构，以证实或核证你的身份，使你能访问参与 Login.gov 的政府机构网站或应用程序。
* 提供给联邦总务管理局（GSA）的专家、顾问或合同商，上述信息与他们执行从事联邦工作有关。
...
所有的记录都以电子形式存储在 GSA 的亚马逊网络服务（AWS）环境中。你可以在[你的账户页面](https://secure.login.gov/account)修改或改变你的电邮地址或电话号码。
...
即便在我们与执法部门分享上述信息时，我们也无法访问你提交的 PII，因为这些信息加密的方式，使 Login.gov 团队无法获取。
