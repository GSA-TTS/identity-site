...
除了验证你提供给我们的身份证明外，我们还采取其他措施来监测和防止欺诈性帐户的创建。我们评估用于访问 Login.gov 的设备、正在验证的身份以及你在身份验证过程中的行为。我们收集设备信息以进行这种评估。我们将在[隐私政策]({% link _policy/index._zh.md %})中进一步详细说明我们如何使用你的信息。

如果你遇到错误，无法完成身份验证和验证流程，我们将提供补救说明和后续操作方法。Login 目前尚未提供通过受信任的推荐人（即在身份验证过程中代表你行事的指定人员）进行身份验证的流程。

### 生物特征数据

某些合作伙伴要求通过生物特征比对进行验证。在这种情况下，Login.gov 将收集你的自拍照，并将其与你政府颁发的身份证件上的肖像进行比对。
