...
component:
  ...
  col2: >-
    ...
    Login.gov utilise [les normes de sécurité les plus élevées]({{ site.baseurl }}/fr/security/) pour protéger vos informations, y compris la vérification d’identité et [l’authentification à deux facteurs]({{ site.baseurl }}/fr/help/authentication-methods/which-authentication-method-should-i-use/).
