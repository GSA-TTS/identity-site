...
Vos informations personnelles seront conservées pendant au moins six ans après la modification d'un mot de passe ou la suppression de votre compte, conformément aux directives de la National Archives and Records Administration (NARA). Cependant, la GSA est autorisée à conserver les informations plus longtemps si elles sont nécessaires à des fins professionnelles. Login.gov doit être en mesure de fournir aux utilisateurs un accès aux informations et aux services des agences partenaires et peut donc avoir un besoin commercial de conserver les informations plus longtemps que la période de conservation de six ans.
