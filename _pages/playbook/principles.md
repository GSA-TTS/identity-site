      ...
      <div class="sm-col sm-col-8">
        <div class="mb4 pt2" id="users">
          ...
          <ul class="list-reset mb3 serif bold list-checked">
            ...
            <li class="mb2 pl3">Conduct research before building or implementing a system
            </li>
            <li class="mb2 pl3">Test your product to identify blind spots or areas for improvement
            </li>
        ...
        <div class="mb4 pt2" id="transparent">
          ...
          <ul class="list-reset mb3 serif bold list-checked">
            ...
            <li class="mb2 pl3">Create a privacy policy that regular people can access and understand
            </li>
        ...
        <div class="mb4 pt2" id="flexible">
          ...
          <ul class="list-reset mb3 serif bold list-checked">
            ...
            <li class="mb2 pl3">Test your product with users continuously as you add new features and refine old ones
            </li>
            <li class="mb2 pl3">Define what a minimal viable product is for your identity management needs
            </li>
        ...
        <div class="mb2 pt2" id="security">
          ...
          <ul class="list-reset mb3 serif bold list-checked">
            ...
            <li class="mb2 pl3">Use modern encryption techniques throughout the technology stack</li>
